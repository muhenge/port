      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <section className="min-h-[calc(100vh-10rem)] sm:min-h-[calc(100vh-8rem)] flex flex-col justify-center items-center text-center">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            {/* Name */}
            <h1 className="text-5xl sm:text-6xl lg:text-7xl xl:text-8xl font-bold text-gray-800 mb-6 leading-tight">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
              <Link
                href="/contact"
                className="bg-black text-white px-8 py-4 text-lg font-semibold hover:bg-white hover:text-black hover:border-2 hover:border-black hover:shadow-lg transition-all duration-300 w-full sm:w-auto"
              >
                Let's get in touch →
              </Link>
              <Link
                href="/work"
                className="border-2 border-gray-300 text-gray-700 px-8 py-4 text-lg font-semibold hover:border-black hover:text-black hover:shadow-lg transition-all duration-300 w-full sm:w-auto"
              >
                View my work
              </Link>
            </div>
            ...
            <div className="flex justify-center items-center space-x-8">
              <a
                ...
                className="flex flex-col items-center text-gray-700 hover:text-black transition-colors duration-300 group"
              >

...
export function Header() {
  return (
    <>
      <header className="hidden sm:flex justify-between items-center p-4 bg-white shadow-md border-t-black">
        <h1 className="text-xl font-bold text-gray-800">My Website</h1>
        <nav className="">
          <ul className="flex space-x-6">
            <Nav text="HOME" url="/home" icon={<HomeIcon className="w-6 h-6" />} />
